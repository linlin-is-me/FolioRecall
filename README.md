...
当前为 **0.1.0rc2 本地预发布候选**。第四阶段核心验收完成，GitHub代码、标签及Release尚未公开上传。2026-09-15复核修订候选整理于 `outputs/stage4/release-v0.1.0rc2-post-audit`，相关CPU验证和重新打包正在进行；9月14日候选保留为历史版本。下文固定版本下载命令供发布后使用，发布前可从验收后的本机候选复制同名资产。发布及后续状态以[开发计划第1节](doc/多模态文档检索项目开发计划.md#当前开发重点)为准。
