...
| 查询部署 | nDCG@10 | Recall@5/10 | 编码 P50/P95 | 完整本地请求 P50/P95 |
|---|---:|---:|---:|---:|
...
全部使用冻结的200查询、原标签和完整1000页原始教师索引，Ryzen 7 8845H与RTX 4060 Laptop、PyTorch线程4、FAISS线程1、batch1，独立进程预热5次、重复3轮，重复排名一致。计时从常驻模型接收文本到Top-10结果JSON就绪，不含进程启动、模型加载或页面渲染。
